...
router.post("/Novo_Agendamento", Funcoes_Agendameto.Novo_Agendamento);
...
router.put("/Modificar_Agendamento", Funcoes_Agendameto.Modificar_Agendamento);
router.delete("/Remover_Agendamento", Funcoes_Agendameto.Remover_Agendamento);
